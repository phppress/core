 ...
 */
#[Group('exception')]
final class UnknownMethodTest extends \PHPUnit\Framework\TestCase
{
    public function testConstructor(): void
    {
        $exception = new UnknownMethod();
    ...
    {
        $exception = new UnknownMethod('Test message');

        $this->assertSame('Unknown method: "Test message"', $exception->getMessage());
        $this->assertSame(0, $exception->getCode());
        $this->assertNull($exception->getPrevious());
    }
    ...
    public function testConstructorWithArguments(): void
    {
        ...
        $exception = new UnknownMethod('Test message', 123, $previousException);
